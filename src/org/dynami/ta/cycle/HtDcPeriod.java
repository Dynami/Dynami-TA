 ...
 * GENERATED CODE
 */
public class HtDcPeriod extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Ht Dc Period - Cycle Indicators";
	}
	 ...
	 * and input Series.
	 */
	public HtDcPeriod compute( final Series inReal) {
		...
		// calculate output
		core.htDcPeriod(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
	...
	public String[] seriesNames() {
		return new String[]{"Ht Dc Period"};
	}
}
