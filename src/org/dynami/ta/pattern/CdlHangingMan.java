 ...
 * GENERATED CODE
 */
public class CdlHangingMan extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Hanging Man";
	}

	@Override
	public String getDescription(){
		return "Cdl Hanging Man - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlHangingMan compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlHangingMan(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Hanging Man"};
	}
}
