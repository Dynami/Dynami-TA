 ...
 * GENERATED CODE
 */
public class CdlStickSandwhich extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Stick Sandwhich";
	}

	@Override
	public String getDescription(){
		return "Cdl Stick Sandwhich - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlStickSandwhich compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlStickSandwhich(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Stick Sandwhich"};
	}
}
