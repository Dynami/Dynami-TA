 ...
 * GENERATED CODE
 */
public class CdlMorningDojiStar extends TaLibIndicator {
	private double penetration = 0.3;
	// output series
	private Series outInteger = new Series();
	
	/**
	 * Default constructor with standard input parameters</br>
	 * default value for penetration = 0.3</br>
	 */
	public CdlMorningDojiStar(){
		computePad(PAD);
	}

	/**
	 * Default constructor with custom input parameters:
	 * @param penetration default value 0.3
	 */
	public CdlMorningDojiStar(double penetration){
	...
	public String getName(){
		return "Cdl Morning Doji Star";
	}

	@Override
	public String getDescription(){
		return "Cdl Morning Doji Star - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlMorningDojiStar compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlMorningDojiStar(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, this.penetration, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Morning Doji Star"};
	}
}
