 ...
 * GENERATED CODE
 */
public class CdlHikkake extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Cdl Hikkake - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlHikkake compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlHikkake(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
