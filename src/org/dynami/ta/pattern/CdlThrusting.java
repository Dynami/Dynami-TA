 ...
 * GENERATED CODE
 */
public class CdlThrusting extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Thrusting";
	}

	@Override
	public String getDescription(){
		return "Cdl Thrusting - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlThrusting compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlThrusting(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Thrusting"};
	}
}
