 ...
 * GENERATED CODE
 */
public class CdlTasukiGap extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Tasuki Gap";
	}

	@Override
	public String getDescription(){
		return "Cdl Tasuki Gap - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlTasukiGap compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlTasukiGap(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Tasuki Gap"};
	}
}
