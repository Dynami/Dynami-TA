 ...
 * GENERATED CODE
 */
public class Cdl2Crows extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Cdl2 Crows - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public Cdl2Crows compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdl2Crows(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
