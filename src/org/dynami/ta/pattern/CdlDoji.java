 ...
 * GENERATED CODE
 */
public class CdlDoji extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Cdl Doji - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlDoji compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlDoji(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
