 ...
 * GENERATED CODE
 */
public class CdlStalledPattern extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Stalled Pattern";
	}

	@Override
	public String getDescription(){
		return "Cdl Stalled Pattern - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlStalledPattern compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlStalledPattern(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Stalled Pattern"};
	}
}
