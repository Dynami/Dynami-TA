 ...
 * GENERATED CODE
 */
public class CdlGapSideSideWhite extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Gap Side Side White";
	}

	@Override
	public String getDescription(){
		return "Cdl Gap Side Side White - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlGapSideSideWhite compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlGapSideSideWhite(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Gap Side Side White"};
	}
}
