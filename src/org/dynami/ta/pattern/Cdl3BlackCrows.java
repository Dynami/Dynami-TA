 ...
 * GENERATED CODE
 */
public class Cdl3BlackCrows extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Cdl3BlackCrows compute( final Series open, final Series high, final Series low, final Series close) {
