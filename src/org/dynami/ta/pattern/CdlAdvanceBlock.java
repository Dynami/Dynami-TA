 ...
 * GENERATED CODE
 */
public class CdlAdvanceBlock extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Advance Block";
	}

	@Override
	public String getDescription(){
		return "Cdl Advance Block - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlAdvanceBlock compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlAdvanceBlock(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Advance Block"};
	}
}
