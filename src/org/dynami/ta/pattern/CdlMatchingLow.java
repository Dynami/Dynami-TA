 ...
 * GENERATED CODE
 */
public class CdlMatchingLow extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Matching Low";
	}

	@Override
	public String getDescription(){
		return "Cdl Matching Low - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlMatchingLow compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlMatchingLow(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Matching Low"};
	}
}
