 ...
 * GENERATED CODE
 */
public class CdlLadderBottom extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Ladder Bottom";
	}

	@Override
	public String getDescription(){
		return "Cdl Ladder Bottom - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlLadderBottom compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlLadderBottom(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Ladder Bottom"};
	}
}
