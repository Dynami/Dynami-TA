 ...
 * GENERATED CODE
 */
public class CdlLongLeggedDoji extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Long Legged Doji";
	}

	@Override
	public String getDescription(){
		return "Cdl Long Legged Doji - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlLongLeggedDoji compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlLongLeggedDoji(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Long Legged Doji"};
	}
}
