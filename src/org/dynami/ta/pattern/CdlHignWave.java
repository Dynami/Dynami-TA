 ...
 * GENERATED CODE
 */
public class CdlHignWave extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Hign Wave";
	}

	@Override
	public String getDescription(){
		return "Cdl Hign Wave - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlHignWave compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlHignWave(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Hign Wave"};
	}
}
