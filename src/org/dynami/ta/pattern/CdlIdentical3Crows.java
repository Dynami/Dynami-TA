 ...
 * GENERATED CODE
 */
public class CdlIdentical3Crows extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Identical3 Crows";
	}

	@Override
	public String getDescription(){
		return "Cdl Identical3 Crows - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlIdentical3Crows compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlIdentical3Crows(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Identical3 Crows"};
	}
}
