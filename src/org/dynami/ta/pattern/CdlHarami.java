 ...
 * GENERATED CODE
 */
public class CdlHarami extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Cdl Harami - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlHarami compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlHarami(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
