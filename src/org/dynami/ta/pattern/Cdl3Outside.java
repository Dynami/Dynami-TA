 ...
 * GENERATED CODE
 */
public class Cdl3Outside extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Cdl3 Outside - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public Cdl3Outside compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdl3Outside(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl3 Outside"};
	}
}
