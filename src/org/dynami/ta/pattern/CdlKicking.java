 ...
 * GENERATED CODE
 */
public class CdlKicking extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Cdl Kicking - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlKicking compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlKicking(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
