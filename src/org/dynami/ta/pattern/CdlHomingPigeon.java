 ...
 * GENERATED CODE
 */
public class CdlHomingPigeon extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Homing Pigeon";
	}

	@Override
	public String getDescription(){
		return "Cdl Homing Pigeon - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlHomingPigeon compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlHomingPigeon(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Homing Pigeon"};
	}
}
