 ...
 * GENERATED CODE
 */
public class CdlBreakaway extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Breakaway";
	}

	@Override
	public String getDescription(){
		return "Cdl Breakaway - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlBreakaway compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlBreakaway(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Breakaway"};
	}
}
