 ...
 * GENERATED CODE
 */
public class CdlShootingStar extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Shooting Star";
	}

	@Override
	public String getDescription(){
		return "Cdl Shooting Star - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlShootingStar compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlShootingStar(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Shooting Star"};
	}
}
