 ...
 * GENERATED CODE
 */
public class CdlBeltHold extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Belt Hold";
	}

	@Override
	public String getDescription(){
		return "Cdl Belt Hold - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlBeltHold compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlBeltHold(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Belt Hold"};
	}
}
