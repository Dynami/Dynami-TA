 ...
 * GENERATED CODE
 */
public class CdlInNeck extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Cdl In Neck - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlInNeck compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlInNeck(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
