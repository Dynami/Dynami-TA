 ...
 * GENERATED CODE
 */
public class CdlDragonflyDoji extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Dragonfly Doji";
	}

	@Override
	public String getDescription(){
		return "Cdl Dragonfly Doji - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlDragonflyDoji compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlDragonflyDoji(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Dragonfly Doji"};
	}
}
