 ...
 * GENERATED CODE
 */
public class CdlConcealBabysWall extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Conceal Babys Wall";
	}

	@Override
	public String getDescription(){
		return "Cdl Conceal Babys Wall - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlConcealBabysWall compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlConcealBabysWall(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Conceal Babys Wall"};
	}
}
