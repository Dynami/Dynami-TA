 ...
 * GENERATED CODE
 */
public class CdlInvertedHammer extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Inverted Hammer";
	}

	@Override
	public String getDescription(){
		return "Cdl Inverted Hammer - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlInvertedHammer compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlInvertedHammer(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Inverted Hammer"};
	}
}
