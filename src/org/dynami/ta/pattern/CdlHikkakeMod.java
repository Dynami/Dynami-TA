 ...
 * GENERATED CODE
 */
public class CdlHikkakeMod extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Hikkake Mod";
	}

	@Override
	public String getDescription(){
		return "Cdl Hikkake Mod - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlHikkakeMod compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlHikkakeMod(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Hikkake Mod"};
	}
}
