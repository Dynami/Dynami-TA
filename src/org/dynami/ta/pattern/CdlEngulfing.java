 ...
 * GENERATED CODE
 */
public class CdlEngulfing extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Engulfing";
	}

	@Override
	public String getDescription(){
		return "Cdl Engulfing - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlEngulfing compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlEngulfing(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Engulfing"};
	}
}
