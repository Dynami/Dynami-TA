 ...
 * GENERATED CODE
 */
public class CdlUpsideGap2Crows extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Upside Gap2 Crows";
	}

	@Override
	public String getDescription(){
		return "Cdl Upside Gap2 Crows - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlUpsideGap2Crows compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlUpsideGap2Crows(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Upside Gap2 Crows"};
	}
}
