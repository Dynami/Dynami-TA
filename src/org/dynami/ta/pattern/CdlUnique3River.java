 ...
 * GENERATED CODE
 */
public class CdlUnique3River extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Unique3 River";
	}

	@Override
	public String getDescription(){
		return "Cdl Unique3 River - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlUnique3River compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlUnique3River(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Unique3 River"};
	}
}
