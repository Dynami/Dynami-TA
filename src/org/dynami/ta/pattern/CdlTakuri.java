 ...
 * GENERATED CODE
 */
public class CdlTakuri extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Cdl Takuri - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlTakuri compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlTakuri(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
