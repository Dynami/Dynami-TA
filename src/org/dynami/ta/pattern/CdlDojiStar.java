 ...
 * GENERATED CODE
 */
public class CdlDojiStar extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Doji Star";
	}

	@Override
	public String getDescription(){
		return "Cdl Doji Star - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlDojiStar compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlDojiStar(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Doji Star"};
	}
}
