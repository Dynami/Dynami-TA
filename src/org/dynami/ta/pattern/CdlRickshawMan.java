 ...
 * GENERATED CODE
 */
public class CdlRickshawMan extends TaLibIndicator implements ITechnicalIndicator {
	...
	public String getName(){
		return "Cdl Rickshaw Man";
	}

	@Override
	public String getDescription(){
		return "Cdl Rickshaw Man - Pattern Recognition";
	}
	...
	public void compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlRickshawMan(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Rickshaw Man"};
	}
}
