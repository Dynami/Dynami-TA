 ...
 * GENERATED CODE
 */
public class CdlDarkCloudCover extends TaLibIndicator {
	private double penetration = 0.5;
	// output series
	private Series outInteger = new Series();
	
	/**
	 * Default constructor with standard input parameters</br>
	 * default value for penetration = 0.5</br>
	 */
	public CdlDarkCloudCover(){
		computePad(PAD);
	}

	/**
	 * Default constructor with custom input parameters:
	 * @param penetration default value 0.5
	 */
	public CdlDarkCloudCover(double penetration){
	...
	public String getName(){
		return "Cdl Dark Cloud Cover";
	}

	@Override
	public String getDescription(){
		return "Cdl Dark Cloud Cover - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlDarkCloudCover compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlDarkCloudCover(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, this.penetration, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Dark Cloud Cover"};
	}
}
