 ...
 * GENERATED CODE
 */
public class Cdl3StarsInSouth extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl3 Stars In South";
	}

	@Override
	public String getDescription(){
		return "Cdl3 Stars In South - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public Cdl3StarsInSouth compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdl3StarsInSouth(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl3 Stars In South"};
	}
}
