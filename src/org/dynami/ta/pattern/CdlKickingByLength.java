 ...
 * GENERATED CODE
 */
public class CdlKickingByLength extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Kicking By Length";
	}

	@Override
	public String getDescription(){
		return "Cdl Kicking By Length - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlKickingByLength compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlKickingByLength(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Kicking By Length"};
	}
}
