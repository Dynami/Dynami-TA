 ...
 * GENERATED CODE
 */
public class CdlXSideGap3Methods extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl X Side Gap3 Methods";
	}

	@Override
	public String getDescription(){
		return "Cdl X Side Gap3 Methods - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlXSideGap3Methods compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlXSideGap3Methods(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl X Side Gap3 Methods"};
	}
}
