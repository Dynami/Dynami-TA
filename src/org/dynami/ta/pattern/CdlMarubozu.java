 ...
 * GENERATED CODE
 */
public class CdlMarubozu extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Cdl Marubozu - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlMarubozu compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlMarubozu(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Marubozu"};
	}
}
