 ...
 * GENERATED CODE
 */
public class Cdl3LineStrike extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl3 Line Strike";
	}

	@Override
	public String getDescription(){
		return "Cdl3 Line Strike - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public Cdl3LineStrike compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdl3LineStrike(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl3 Line Strike"};
	}
}
