 ...
 * GENERATED CODE
 */
public class Cdl3WhiteSoldiers extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl3 White Soldiers";
	}

	@Override
	public String getDescription(){
		return "Cdl3 White Soldiers - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public Cdl3WhiteSoldiers compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdl3WhiteSoldiers(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl3 White Soldiers"};
	}
}
