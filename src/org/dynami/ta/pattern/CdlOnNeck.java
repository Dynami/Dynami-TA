 ...
 * GENERATED CODE
 */
public class CdlOnNeck extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Cdl On Neck - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlOnNeck compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlOnNeck(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
