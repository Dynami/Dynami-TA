 ...
 * GENERATED CODE
 */
public class CdlSpinningTop extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Spinning Top";
	}

	@Override
	public String getDescription(){
		return "Cdl Spinning Top - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlSpinningTop compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlSpinningTop(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Spinning Top"};
	}
}
