 ...
 * GENERATED CODE
 */
public class CdlAbandonedBaby extends TaLibIndicator {
	 ...
	 */
	public CdlAbandonedBaby(double penetration){
	...
	public String getName(){
		return "Cdl Abandoned Baby";
	}

	@Override
	public String getDescription(){
		return "Cdl Abandoned Baby - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlAbandonedBaby compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlAbandonedBaby(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, this.penetration, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Abandoned Baby"};
	}
}
