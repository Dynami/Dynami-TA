 ...
 * GENERATED CODE
 */
public class CdlSeperatingLines extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Seperating Lines";
	}

	@Override
	public String getDescription(){
		return "Cdl Seperating Lines - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlSeperatingLines compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlSeperatingLines(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Seperating Lines"};
	}
}
