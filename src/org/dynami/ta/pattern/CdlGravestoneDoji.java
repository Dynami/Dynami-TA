 ...
 * GENERATED CODE
 */
public class CdlGravestoneDoji extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Gravestone Doji";
	}

	@Override
	public String getDescription(){
		return "Cdl Gravestone Doji - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlGravestoneDoji compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlGravestoneDoji(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Gravestone Doji"};
	}
}
