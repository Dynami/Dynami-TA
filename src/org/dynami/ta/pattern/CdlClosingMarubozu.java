 ...
 * GENERATED CODE
 */
public class CdlClosingMarubozu extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Closing Marubozu";
	}

	@Override
	public String getDescription(){
		return "Cdl Closing Marubozu - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlClosingMarubozu compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlClosingMarubozu(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Closing Marubozu"};
	}
}
