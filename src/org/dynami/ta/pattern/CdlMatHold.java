 ...
 * GENERATED CODE
 */
public class CdlMatHold extends TaLibIndicator {
	 ...
	 */
	public CdlMatHold(double penetration){
	...
	public String getDescription(){
		return "Cdl Mat Hold - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlMatHold compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlMatHold(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, this.penetration, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Mat Hold"};
	}
}
