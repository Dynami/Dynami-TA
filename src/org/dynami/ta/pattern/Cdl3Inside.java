 ...
 * GENERATED CODE
 */
public class Cdl3Inside extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Cdl3 Inside - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public Cdl3Inside compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdl3Inside(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
