 ...
 * GENERATED CODE
 */
public class CdlHaramiCross extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Harami Cross";
	}

	@Override
	public String getDescription(){
		return "Cdl Harami Cross - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlHaramiCross compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlHaramiCross(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Harami Cross"};
	}
}
