 ...
 * GENERATED CODE
 */
public class CdlCounterAttack extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Counter Attack";
	}

	@Override
	public String getDescription(){
		return "Cdl Counter Attack - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlCounterAttack compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlCounterAttack(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Counter Attack"};
	}
}
