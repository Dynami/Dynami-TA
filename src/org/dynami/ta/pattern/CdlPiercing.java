 ...
 * GENERATED CODE
 */
public class CdlPiercing extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Cdl Piercing - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlPiercing compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlPiercing(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Piercing"};
	}
}
