 ...
 * GENERATED CODE
 */
public class CdlLongLine extends TaLibIndicator {
	// output series
	...
	public String getName(){
		return "Cdl Long Line";
	}

	@Override
	public String getDescription(){
		return "Cdl Long Line - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlLongLine compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlLongLine(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Long Line"};
	}
}
