 ...
 * GENERATED CODE
 */
public class CdlHammer extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Cdl Hammer - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlHammer compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlHammer(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outInteger);
