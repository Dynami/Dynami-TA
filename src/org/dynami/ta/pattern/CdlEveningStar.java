 ...
 * GENERATED CODE
 */
public class CdlEveningStar extends TaLibIndicator {
	 ...
	 */
	public CdlEveningStar(double penetration){
	...
	public String getName(){
		return "Cdl Evening Star";
	}

	@Override
	public String getDescription(){
		return "Cdl Evening Star - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlEveningStar compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlEveningStar(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, this.penetration, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Evening Star"};
	}
}
