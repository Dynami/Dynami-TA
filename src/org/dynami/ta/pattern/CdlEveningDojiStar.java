 ...
 * GENERATED CODE
 */
public class CdlEveningDojiStar extends TaLibIndicator {
	 ...
	 */
	public CdlEveningDojiStar(double penetration){
	...
	public String getName(){
		return "Cdl Evening Doji Star";
	}

	@Override
	public String getDescription(){
		return "Cdl Evening Doji Star - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlEveningDojiStar compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlEveningDojiStar(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, this.penetration, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Evening Doji Star"};
	}
}
