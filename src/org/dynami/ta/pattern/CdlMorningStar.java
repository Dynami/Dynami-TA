 ...
 * GENERATED CODE
 */
public class CdlMorningStar extends TaLibIndicator {
	 ...
	 */
	public CdlMorningStar(double penetration){
	...
	public String getName(){
		return "Cdl Morning Star";
	}

	@Override
	public String getDescription(){
		return "Cdl Morning Star - Pattern Recognition";
	}
	 ...
	 * and input Series.
	 */
	public CdlMorningStar compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cdlMorningStar(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, this.penetration, outBegIdx, outNBElement, _outInteger);
	...
	public String[] seriesNames() {
		return new String[]{"Cdl Morning Star"};
	}
}
