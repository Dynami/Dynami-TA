 ...
 * GENERATED CODE
 */
public class Div extends TaLibIndicator implements ITechnicalIndicator {
	...
	public void compute( final Series inReal0, final Series inReal1) {
		...
		// calculate output
		core.div(0, _tmpinReal0.length-1, _tmpinReal0, _tmpinReal1, outBegIdx, outNBElement, _outReal);
