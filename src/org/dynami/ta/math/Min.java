 ...
 * GENERATED CODE
 */
public class Min extends TaLibIndicator {
	 ...
	 * and input Series.
	 */
	public Min compute( final Series inReal) {
		...
		// calculate output
		core.min(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
