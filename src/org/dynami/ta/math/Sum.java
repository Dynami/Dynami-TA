 ...
 * GENERATED CODE
 */
public class Sum extends TaLibIndicator {
	 ...
	 * and input Series.
	 */
	public Sum compute( final Series inReal) {
		...
		// calculate output
		core.sum(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
