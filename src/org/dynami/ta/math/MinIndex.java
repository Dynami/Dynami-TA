 ...
 * GENERATED CODE
 */
public class MinIndex extends TaLibIndicator {
	 ...
	 */
	public MinIndex(int timePeriod){
	...
	public String getDescription(){
		return "Min Index - Math Operators";
	}
	 ...
	 * and input Series.
	 */
	public MinIndex compute( final Series inReal) {
		...
		// calculate output
		core.minIndex(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outInteger);
