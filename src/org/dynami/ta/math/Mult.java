 ...
 * GENERATED CODE
 */
public class Mult extends TaLibIndicator implements ITechnicalIndicator {
	 ...
	 * and input Series.
	 */
	public void compute( final Series inReal0, final Series inReal1) {
		...
		ready = DUtils.max(_tmpinReal0.length, _tmpinReal1.length) >= DUtils.max();
		// calculate output
		core.mult(0, _tmpinReal0.length-1, _tmpinReal0, _tmpinReal1, outBegIdx, outNBElement, _outReal);
