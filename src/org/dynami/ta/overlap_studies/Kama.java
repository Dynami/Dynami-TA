 ...
 * GENERATED CODE
 */
public class Kama extends TaLibIndicator {
	 ...
	 * and input Series.
	 */
	public Kama compute( final Series inReal) {
		...
		// calculate output
		core.kama(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
