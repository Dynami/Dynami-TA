 ...
 * GENERATED CODE
 */
public class HtTrendline extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Ht Trendline - Overlap Studies";
	}
	 ...
	 * and input Series.
	 */
	public HtTrendline compute( final Series inReal) {
		...
		// calculate output
		core.htTrendline(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
	...
	public String[] seriesNames() {
		return new String[]{"Ht Trendline"};
	}
}
