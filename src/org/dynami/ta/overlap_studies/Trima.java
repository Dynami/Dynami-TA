 ...
 * GENERATED CODE
 */
public class Trima extends TaLibIndicator {
	 ...
	 * and input Series.
	 */
	public Trima compute( final Series inReal) {
		...
		// calculate output
		core.trima(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
