 ...
 * GENERATED CODE
 */
public class MidPrice extends TaLibIndicator implements ITechnicalIndicator {
	 ...
	 */
	public MidPrice(int timePeriod){
	...
	public String getDescription(){
		return "Mid Price - Overlap Studies";
	}
	...
	public void compute( final Series high, final Series low) {
		...
		// calculate output
		core.midPrice(0, _tmphigh.length-1, _tmphigh, _tmplow, this.timePeriod, outBegIdx, outNBElement, _outReal);
