 ...
 * GENERATED CODE
 */
public class MidPoint extends TaLibIndicator {
	 ...
	 */
	public MidPoint(int timePeriod){
	...
	public String getDescription(){
		return "Mid Point - Overlap Studies";
	}
	 ...
	 * and input Series.
	 */
	public MidPoint compute( final Series inReal) {
		...
		// calculate output
		core.midPoint(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
