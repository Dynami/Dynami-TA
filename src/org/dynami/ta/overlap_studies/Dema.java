 ...
 * GENERATED CODE
 */
public class Dema extends TaLibIndicator {
	 ...
	 * and input Series.
	 */
	public Dema compute( final Series inReal) {
		...
		// calculate output
		core.dema(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
