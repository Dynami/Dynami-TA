...
public class MovingAverage extends TaLibIndicator {
	 ...
	 */
	public MovingAverage(int timePeriod, MAType mAType){
	...
	public String getDescription(){
		return "Moving Average - Overlap Studies";
	}
	 ...
	 * and input Series.
	 */
	public MovingAverage compute( final Series inReal) {
		...
		// calculate output
		core.movingAverage(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, this.mAType, outBegIdx, outNBElement, _outReal);
	...
	public String[] seriesNames() {
		return new String[]{"Moving Average"};
	}
}
