 ...
 * GENERATED CODE
 */
public class Ema extends TaLibIndicator {
	 ...
	 * and input Series.
	 */
	public Ema compute( final Series inReal) {
		...
		// calculate output
		core.ema(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
