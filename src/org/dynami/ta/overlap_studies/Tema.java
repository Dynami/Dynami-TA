 ...
 * GENERATED CODE
 */
public class Tema extends TaLibIndicator {
	 ...
	 * and input Series.
	 */
	public Tema compute( final Series inReal) {
		...
		// calculate output
		core.tema(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
