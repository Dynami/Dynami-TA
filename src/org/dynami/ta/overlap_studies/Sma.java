 ...
 * GENERATED CODE
 */
public class Sma extends TaLibIndicator implements ITechnicalIndicator {
	...
	public void compute( final Series inReal) {
		...
		// calculate output
		core.sma(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
