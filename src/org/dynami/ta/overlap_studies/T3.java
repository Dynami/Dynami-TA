 ...
 * GENERATED CODE
 */
public class T3 extends TaLibIndicator {
	 ...
	 * default value for volumeFactor = 0.7</br>
	 */
	public T3(){
	 ...
	 * @param volumeFactor default value 0.7
	 */
	public T3(int timePeriod, double volumeFactor){
	 ...
	 * and input Series.
	 */
	public T3 compute( final Series inReal) {
		...
		// calculate output
		core.t3(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, this.volumeFactor, outBegIdx, outNBElement, _outReal);
