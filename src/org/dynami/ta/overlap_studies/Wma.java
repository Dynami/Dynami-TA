 ...
 * GENERATED CODE
 */
public class Wma extends TaLibIndicator {
	 ...
	 * and input Series.
	 */
	public Wma compute( final Series inReal) {
		...
		// calculate output
		core.wma(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
