 ...
 * GENERATED CODE
 */
public class MinusDM extends TaLibIndicator {
	...
	public String getDescription(){
		return "Minus D M - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public MinusDM compute( final Series high, final Series low) {
		...
		// calculate output
		core.minusDM(0, _tmphigh.length-1, _tmphigh, _tmplow, this.timePeriod, outBegIdx, outNBElement, _outReal);
