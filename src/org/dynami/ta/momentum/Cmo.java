 ...
 * GENERATED CODE
 */
public class Cmo extends TaLibIndicator {
	...
	public String getDescription(){
		return "Cmo - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public Cmo compute( final Series inReal) {
		...
		// calculate output
		core.cmo(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
