 ...
 * GENERATED CODE
 */
public class RocR100 extends TaLibIndicator {
	...
	public String getDescription(){
		return "Roc R100 - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public RocR100 compute( final Series inReal) {
		...
		// calculate output
		core.rocR100(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
