 ...
 * GENERATED CODE
 */
public class Rsi extends TaLibIndicator implements ITechnicalIndicator {
	...
	public String getDescription(){
		return "Rsi - Momentum Indicators";
	}
	...
	public void compute( final Series inReal) {
		...
		// calculate output
		core.rsi(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
