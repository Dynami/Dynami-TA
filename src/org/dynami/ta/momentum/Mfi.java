 ...
 * GENERATED CODE
 */
public class Mfi extends TaLibIndicator implements ITechnicalIndicator {
	...
	public String getDescription(){
		return "Mfi - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public void compute( final Series high, final Series low, final Series close, final Series volume) {
		...
		ready = DUtils.max(_tmphigh.length, _tmplow.length, _tmpclose.length, _tmpvolume.length) >= DUtils.max(timePeriod);
		// calculate output
		core.mfi(0, _tmphigh.length-1, _tmphigh, _tmplow, _tmpclose, _tmpvolume, this.timePeriod, outBegIdx, outNBElement, _outReal);
