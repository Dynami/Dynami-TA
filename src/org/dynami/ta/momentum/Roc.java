 ...
 * GENERATED CODE
 */
public class Roc extends TaLibIndicator {
	...
	public String getDescription(){
		return "Roc - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public Roc compute( final Series inReal) {
		...
		// calculate output
		core.roc(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
