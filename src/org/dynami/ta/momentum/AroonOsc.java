 ...
 * GENERATED CODE
 */
public class AroonOsc extends TaLibIndicator {
	 ...
	 */
	public AroonOsc(int timePeriod){
	...
	public String getDescription(){
		return "Aroon Osc - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public AroonOsc compute( final Series high, final Series low) {
		...
		// calculate output
		core.aroonOsc(0, _tmphigh.length-1, _tmphigh, _tmplow, this.timePeriod, outBegIdx, outNBElement, _outReal);
