 ...
 * GENERATED CODE
 */
public class Ppo extends TaLibIndicator {
	 ...
	 */
	public Ppo(int fastPeriod, int slowPeriod, MAType mAType){
	...
	public String getDescription(){
		return "Ppo - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public Ppo compute( final Series inReal) {
		...
		// calculate output
		core.ppo(0, _tmpinReal.length-1, _tmpinReal, this.fastPeriod, this.slowPeriod, this.mAType, outBegIdx, outNBElement, _outReal);
