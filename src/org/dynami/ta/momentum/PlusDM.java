 ...
 * GENERATED CODE
 */
public class PlusDM extends TaLibIndicator {
	...
	public String getDescription(){
		return "Plus D M - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public PlusDM compute( final Series high, final Series low) {
		...
		// calculate output
		core.plusDM(0, _tmphigh.length-1, _tmphigh, _tmplow, this.timePeriod, outBegIdx, outNBElement, _outReal);
