 ...
 * GENERATED CODE
 */
public class Adxr extends TaLibIndicator {
	...
	public String getDescription(){
		return "Adxr - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public Adxr compute( final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.adxr(0, _tmphigh.length-1, _tmphigh, _tmplow, _tmpclose, this.timePeriod, outBegIdx, outNBElement, _outReal);
