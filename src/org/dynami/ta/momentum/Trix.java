 ...
 * GENERATED CODE
 */
public class Trix extends TaLibIndicator {
	...
	public String getDescription(){
		return "Trix - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public Trix compute( final Series inReal) {
		...
		// calculate output
		core.trix(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
