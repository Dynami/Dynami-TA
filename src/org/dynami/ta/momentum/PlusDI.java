 ...
 * GENERATED CODE
 */
public class PlusDI extends TaLibIndicator {
	...
	public String getDescription(){
		return "Plus D I - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public PlusDI compute( final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.plusDI(0, _tmphigh.length-1, _tmphigh, _tmplow, _tmpclose, this.timePeriod, outBegIdx, outNBElement, _outReal);
