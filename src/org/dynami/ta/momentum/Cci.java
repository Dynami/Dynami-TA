 ...
 * GENERATED CODE
 */
public class Cci extends TaLibIndicator {
	...
	public String getDescription(){
		return "Cci - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public Cci compute( final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.cci(0, _tmphigh.length-1, _tmphigh, _tmplow, _tmpclose, this.timePeriod, outBegIdx, outNBElement, _outReal);
