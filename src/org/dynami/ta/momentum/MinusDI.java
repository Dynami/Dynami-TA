 ...
 * GENERATED CODE
 */
public class MinusDI extends TaLibIndicator {
	...
	public String getDescription(){
		return "Minus D I - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public MinusDI compute( final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.minusDI(0, _tmphigh.length-1, _tmphigh, _tmplow, _tmpclose, this.timePeriod, outBegIdx, outNBElement, _outReal);
