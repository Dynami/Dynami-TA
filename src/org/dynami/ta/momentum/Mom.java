 ...
 * GENERATED CODE
 */
public class Mom extends TaLibIndicator {
	...
	public String getDescription(){
		return "Mom - Momentum Indicators";
	}
	 ...
	 * and input Series.
	 */
	public Mom compute( final Series inReal) {
		...
		// calculate output
		core.mom(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
