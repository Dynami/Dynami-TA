 ...
 * GENERATED CODE
 */
public class Beta extends TaLibIndicator implements ITechnicalIndicator {
	...
	public String getDescription(){
		return "Beta - Statistic Functions";
	}
	...
	public void compute( final Series inReal0, final Series inReal1) {
		...
		// calculate output
		core.beta(0, _tmpinReal0.length-1, _tmpinReal0, _tmpinReal1, this.timePeriod, outBegIdx, outNBElement, _outReal);
