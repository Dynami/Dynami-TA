 ...
 * GENERATED CODE
 */
public class Variance extends TaLibIndicator {
	private int timePeriod = 5;
	private double deviations = 1.0;
	// output series
	 ...
	 * default value for deviations = 1.0</br>
	 */
	public Variance(){
	 ...
	 * @param deviations default value 1.0
	 */
	public Variance(int timePeriod, double deviations){
	...
	public String getDescription(){
		return "Variance - Statistic Functions";
	}
	 ...
	 * and input Series.
	 */
	public Variance compute( final Series inReal) {
		...
		// calculate output
		core.variance(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, this.deviations, outBegIdx, outNBElement, _outReal);
