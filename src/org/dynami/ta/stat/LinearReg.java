...
public class LinearReg extends TaLibIndicator {
	 ...
	 */
	public LinearReg(int timePeriod){
	...
	public String getDescription(){
		return "Linear Reg - Statistic Functions";
	}
	 ...
	 * and input Series.
	 */
	public LinearReg compute( final Series inReal) {
		...
		// calculate output
		core.linearReg(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
