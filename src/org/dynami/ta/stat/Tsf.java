 ...
 * GENERATED CODE
 */
public class Tsf extends TaLibIndicator {
	...
	public String getDescription(){
		return "Tsf - Statistic Functions";
	}
	 ...
	 * and input Series.
	 */
	public Tsf compute( final Series inReal) {
		...
		// calculate output
		core.tsf(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
