 ...
 * GENERATED CODE
 */
public class StdDev extends TaLibIndicator {
	 ...
	 */
	public StdDev(int timePeriod, double deviations){
	...
	public String getDescription(){
		return "Std Dev - Statistic Functions";
	}
	 ...
	 * and input Series.
	 */
	public StdDev compute( final Series inReal) {
		...
		// calculate output
		core.stdDev(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, this.deviations, outBegIdx, outNBElement, _outReal);
