 ...
 * GENERATED CODE
 */
public class LinearRegAngle extends TaLibIndicator {
	 ...
	 */
	public LinearRegAngle(int timePeriod){
	...
	public String getName(){
		return "Linear Reg Angle";
	}

	@Override
	public String getDescription(){
		return "Linear Reg Angle - Statistic Functions";
	}
	 ...
	 * and input Series.
	 */
	public LinearRegAngle compute( final Series inReal) {
		...
		// calculate output
		core.linearRegAngle(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
	...
	public String[] seriesNames() {
		return new String[]{"Linear Reg Angle"};
	}
}
