 ...
 * GENERATED CODE
 */
public class LinearRegSlope extends TaLibIndicator {
	 ...
	 */
	public LinearRegSlope(int timePeriod){
	...
	public String getName(){
		return "Linear Reg Slope";
	}

	@Override
	public String getDescription(){
		return "Linear Reg Slope - Statistic Functions";
	}
	 ...
	 * and input Series.
	 */
	public LinearRegSlope compute( final Series inReal) {
		...
		// calculate output
		core.linearRegSlope(0, _tmpinReal.length-1, _tmpinReal, this.timePeriod, outBegIdx, outNBElement, _outReal);
	...
	public String[] seriesNames() {
		return new String[]{"Linear Reg Slope"};
	}
}
