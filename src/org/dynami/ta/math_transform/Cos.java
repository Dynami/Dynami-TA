 ...
 * GENERATED CODE
 */
public class Cos extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Cos compute( final Series inReal) {
		...
		// calculate output
		core.cos(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
