 ...
 * GENERATED CODE
 */
public class Ceil extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Ceil compute( final Series inReal) {
		...
		// calculate output
		core.ceil(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
