 ...
 * GENERATED CODE
 */
public class Sinh extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Sinh compute( final Series inReal) {
		...
		// calculate output
		core.sinh(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
