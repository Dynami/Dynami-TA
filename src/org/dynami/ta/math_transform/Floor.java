 ...
 * GENERATED CODE
 */
public class Floor extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Floor compute( final Series inReal) {
		...
		// calculate output
		core.floor(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
