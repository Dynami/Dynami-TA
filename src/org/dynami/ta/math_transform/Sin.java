 ...
 * GENERATED CODE
 */
public class Sin extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Sin compute( final Series inReal) {
		...
		// calculate output
		core.sin(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
