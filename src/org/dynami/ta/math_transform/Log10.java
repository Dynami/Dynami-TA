 ...
 * GENERATED CODE
 */
public class Log10 extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Log10 compute( final Series inReal) {
		...
		// calculate output
		core.log10(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
