 ...
 * GENERATED CODE
 */
public class Exp extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Exp compute( final Series inReal) {
		...
		// calculate output
		core.exp(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
