 ...
 * GENERATED CODE
 */
public class Ln extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Ln compute( final Series inReal) {
		...
		// calculate output
		core.ln(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
