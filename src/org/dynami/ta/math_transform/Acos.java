 ...
 * GENERATED CODE
 */
public class Acos extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Acos compute( final Series inReal) {
		...
		// calculate output
		core.acos(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
