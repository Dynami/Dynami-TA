 ...
 * GENERATED CODE
 */
public class Asin extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Asin compute( final Series inReal) {
		...
		// calculate output
		core.asin(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
