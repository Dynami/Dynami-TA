 ...
 * GENERATED CODE
 */
public class Cosh extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Cosh compute( final Series inReal) {
		...
		// calculate output
		core.cosh(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
