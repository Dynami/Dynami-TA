 ...
 * GENERATED CODE
 */
public class Atan extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Atan compute( final Series inReal) {
		...
		// calculate output
		core.atan(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
