 ...
 * GENERATED CODE
 */
public class Tanh extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Tanh compute( final Series inReal) {
		...
		// calculate output
		core.tanh(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
