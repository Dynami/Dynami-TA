 ...
 * GENERATED CODE
 */
public class Sqrt extends TaLibIndicator {
	// output series
	 ...
	 * and input Series.
	 */
	public Sqrt compute( final Series inReal) {
		...
		// calculate output
		core.sqrt(0, _tmpinReal.length-1, _tmpinReal, outBegIdx, outNBElement, _outReal);
