 ...
 * GENERATED CODE
 */
public class TypPrice extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Typ Price - Price Transform";
	}
	 ...
	 * and input Series.
	 */
	public TypPrice compute( final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.typPrice(0, _tmphigh.length-1, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outReal);
