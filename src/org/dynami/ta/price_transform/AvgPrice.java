 ...
 * GENERATED CODE
 */
public class AvgPrice extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "Avg Price - Price Transform";
	}
	 ...
	 * and input Series.
	 */
	public AvgPrice compute( final Series open, final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.avgPrice(0, _tmpopen.length-1, _tmpopen, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outReal);
