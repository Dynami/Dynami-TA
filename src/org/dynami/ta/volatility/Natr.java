 ...
 * GENERATED CODE
 */
public class Natr extends TaLibIndicator {
	...
	public String getDescription(){
		return "Natr - Volatility Indicators";
	}
	 ...
	 * and input Series.
	 */
	public Natr compute( final Series high, final Series low, final Series close) {
		...
		// calculate output
		core.natr(0, _tmphigh.length-1, _tmphigh, _tmplow, _tmpclose, this.timePeriod, outBegIdx, outNBElement, _outReal);
