 ...
 * GENERATED CODE
 */
public class TrueRange extends TaLibIndicator {
	// output series
	...
	public String getDescription(){
		return "True Range - Volatility Indicators";
	}
	 ...
	 * and input Series.
	 */
	public TrueRange compute( final Series high, final Series low, final Series close) {
		...
		ready = DUtils.max(_tmphigh.length, _tmplow.length, _tmpclose.length) >= DUtils.max();
		// calculate output
		core.trueRange(0, _tmphigh.length-1, _tmphigh, _tmplow, _tmpclose, outBegIdx, outNBElement, _outReal);
